...
# Set up geometry:
rmin, rmax, ref_level, nlayers = 1.22, 2.22, 8, 128
...
delta_t = Constant(6.25e-09)  # Initial time-step
...
stokes_solver.solver_parameters['fieldsplit_0']['pc_python_type'] = __name__ + ".SPDAssembledPC"
